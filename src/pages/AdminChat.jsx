                    ...
                    {activeTab === 'message' && (
                        ...
                        <div className="flex flex-col h-screen">
                            <div className="p-4 border-b border-gray-200 bg-white">
                                ...
                                <p><span className='text-lg font-semibold'>Email: </span>{setInfo.email}</p>
                                <p><span className='text-lg font-semibold'>Mob: </span>{setInfo.mobile_number}</p>
                                <p><span className='text-lg font-semibold'>Enquiry For: </span>{setInfo.service} On <span className='text-lg font-semibold'>{dayjs(setInfo?.created_at).format('YY/MM/DD HH:mm')}</span></p>
                            </div>
