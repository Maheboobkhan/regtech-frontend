...
class RolePostpaid_Dashboard extends Component {
  ...
  handleInputChange = (e) => {
    ...
    this.setState({totalAmount:(parseFloat(amount) + parseFloat(tax)).toFixed(2)})
  };
  ...
  handlePayment = async (id, name, email, token) => {
    ...
    alert('Payment Method has not been Setup, We will Integrate it soon.');
  ...
  render() {
    ...
    return (
      ...
      <div className="font-halvetica hidden md:flex relative">
        ...
        <div
          className={`sidebar-transition fixed shadow-2xl min-h-screen max-h-screen overflow-y-auto bg-black z-10 ${
            ...
            <div className="flex items-center">
              <div className="flex flex-col mr-10 text-white">
                <h3 className="font-medium text-black">
                  ...
                  {user.wallet_amount === null ? 0 : user.wallet_amount}
                </h3>
                <button
...
export default withRouter(RolePostpaid_Dashboard);
