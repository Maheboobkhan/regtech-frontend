...
import EquifaxPdfReport from "../DashboardComponent/CREDIT SCORE/EquifaxPdfReport";
import SearchData from "../DashboardComponent/SEARCH/SearchAllData";
import PaginatedTable from "../DashboardComponent/SEARCH/SearchTest";
import SearchData2 from "../DashboardComponent/SEARCH/SearchTest";
import ESignForm from "../DashboardComponent/ESIGN/Esign";
import ResponseNew from "../DashboardComponent/ESIGN/Response";
class Role0_Dashboard extends Component {
  ...
  getActiveMenu(path) {
    ...
    const pathToMenu = {
      ...
      "/dashboard/search/data": "Search All Data",
  ...
  render() {
    ...
    return (
      ...
      <div className="font-halvetica hidden md:flex relative">
        ...
        <div
          className={`sidebar-transition fixed pb-4 shadow-2xl min-h-screen max-h-screen overflow-y-auto bg-black z-10 ${
          ...
          {!sidebarOpen && (
            <ul className="flex flex-col justify-between min-h-[89%] mt-1 text-sm px-4 gap-y-1">
              ...
              <Link to="/dashboard/search/data">
                <div
                  className={`button font-montserrat font-light flex cursor-pointer py-3 transition-all gap-x-2 rounded-sm text-white hover:bg-[#00acc1] active:bg-[#21a2b3] ${
                    activeMenu === "Search All Data" ? "bg-[#00acc1]" : ""
                  }`}
                  onClick={() => this.setActiveMenu("Search All Data")}
                >
                  <RiMenuSearchLine className="text-xl ml-8"/>
                  <li>Search All Data</li>
                </div>
              </Link>
        ...
        >
          ...
          <Routes>
            ...
            <Route path="/search/data" element={<SearchData2 />} />
            ...
            <Route path="/pdf" element={<EquifaxPdfReport />} />
            ...
            <Route path="/kyc/esign-initialize" element={<ESignForm />} />




            {/* Search Test */}
            {/* <Route path="/kyc/single/search-test/api" element={<PaginatedTable />} /> */}
          </Routes>
        </div>
        {/* useradmin */}
        {/* <div
