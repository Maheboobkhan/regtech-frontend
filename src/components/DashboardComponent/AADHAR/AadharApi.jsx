...
// // import './App.css'; // Ensure you include Tailwind CSS in your project
...
//             onClick={() => this.toggleSection("aadhaarApis")}
//           >
//             <h3 className="font-bold">Aadhaar APIs</h3>
//           </div>
//           <div className="space-y-4">
//             {/* Aadhaar Validation */}
//             {expandedSection === "aadhaarApis" && (
//               <>
//                 <div
//                   className="bg-blue-300 text-white p-4 rounded cursor-pointer"
        ...
        <div className="space-y-4">
          ...
          <div
            className={`bg-[#cee5ff] rounded cursor-pointer transition-all duration-300 ${
              showAadhaarApis ? "h-auto transition-all duration-300" : "h-18 flex items-center"
            }`}
            
          >
            <h3 className={`font-bold rounded pl-2 py-4 text-xl bg-blue-300 w-[100%] ${
              showAadhaarApis ? "bg-[#4cb4ff] text-white" : "h-[100%]"}
            `} onClick={this.toggleAadhaarApis}>Aadhaar APIs</h3>
