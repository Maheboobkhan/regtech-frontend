  ...
  handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${domain}/aadharcard_mask`,
        // "https://regtechapi.in/api/aadharcard_mask",
        formData,
        {
          headers: {
            AccessToken: token,
          ...
          <div className="p-4">
            ...
            {response && response.data.status_code === 200 && (
              ...
              <div className="bg-blue-400 text-white p-3 rounded mt-4 mb-4">
                <img
                  src={response.data.aadharcard.data}
                  // src={`data:image/png;base64,${response.data.aadharcard.data}`}
                  alt="Masked Aadhaar Back"
                  style={{ width: "100%" }}
                />
              </div>
            )}
