...
//                             <p><strong>cinNumber:</strong> {response.corporate_cin.data.cin || 'null'}</p>
//                             <p><strong>numberOfMembers:</strong> {response.corporate_cin.data.numberOfMembers || 'null'}</p>
//                             <p><strong>subCategory:</strong> {response.corporate_cin.data.subCategory || 'null'}</p>
//                             <p><strong>classType:</strong> {response.corporate_cin.data.classType || 'null'}</p>
//                             <p><strong>companyType:</strong> {response.corporate_cin.data.companyType || 'null'}</p>
//                             <p><strong>companyName:</strong> {response.corporate_cin.data.companyName || 'null'}</p>
//                             <p><strong>paidUpCapital:</strong> {response.corporate_cin.data.paidUpCapital || 'null'}</p>
//                             <p><strong>authorisedCapital:</strong> {response.corporate_cin.data..authorisedCapital || 'null'}</p>
//                             <p><strong>whetherListed:</strong> {response.corporate_cin.data.whetherListed || 'null'}</p>
//                             <p><strong>dateOfIncorporation:</strong> {response.corporate_cin.data.dateOfIncorporation || 'null'}</p>
//                             <p><strong>registrationNumber:</strong> {response.corporate_cin.data.registrationNumber || 'null'}</p>
//                             <p><strong>registeredAddress:</strong> {response.corporate_cin.data.registeredAddress || 'null'}</p>
//                             <p><strong>registeredDistrict:</strong> {response.corporate_cin.data.registeredDistrict || 'null'}</p>
//                             <p><strong>registeredState:</strong> {response.corporate_cin.data.registeredState || 'null'}</p>
//                             <p><strong>registeredCity:</strong> {response.corporate_cin.data.registeredCity || 'null'}</p>
//                             <p><strong>registeredPincode:</strong> {response.corporate_cin.data.registeredPincode || 'null'}</p>
//                             <p><strong>registeredCountry:</strong> {response.corporate_cin.data.registeredCountry || 'null'}</p>
//                             <p><strong>activeCompliance:</strong> {response.corporate_cin.data.activeCompliance || 'null'}</p>
...
//                             <p><strong>rocOffice:</strong> {response.corporate_cin.data.rocOffice || 'null'}</p>
//                             <p><strong>addressOtherThanRegisteredOffice:</strong> {response.corporate_cin.data.addressOtherThanRegisteredOffice || 'null'}</p>
//                             <p><strong>emailId:</strong> {response.corporate_cin.data.emailId || 'null'}</p>
//                             <p><strong>natureOfBusiness:</strong> {response.corporate_cin.data.natureOfBusiness || 'null'}</p>
//                             <p><strong>noOfDirectors:</strong> {response.corporate_cin.data.noOfDirectors || 'null'}</p>
//                             <p><strong>statusForEfiling:</strong> {response.corporate_cin.data.statusForEfiling || 'null'}</p>
//                         </div>
//                     )}
//                 </div>
//             </div>
