  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        'https://regtechapi.in/api/udyamsearch',
        { udyamNumber },
        {
          headers: {
  ...
  return (
    <div className="mt-32 mx-auto w-full max-w-lg bg-white shadow-lg rounded-lg overflow-hidden">
      <div className="bg-[#00acc1] p-4 flex justify-between items-center">
        <h3 className="text-xl font-semibold text-white">Udyam Registration Search</h3>
        <Link
          to="/dashboard/kyc/udyam_api"
