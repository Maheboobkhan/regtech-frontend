...
const FaceMatch = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${domain}/face_match`, formData, { headers });
      // console.log(res)
            ...
            <>
              {response.statusCode === 200 && (
                <div className="bg-green-100 text-green-800 p-3 rounded mt-4">
                  ...
                  <p><strong>Confidence: </strong>Face Matched with <span className='font-bold'>{response.face_match.response.confidence}%</span> Confidence</p>
                </div>
              )}
