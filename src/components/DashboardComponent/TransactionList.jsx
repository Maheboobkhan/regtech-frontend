...
//         `http://localhost:8000/api/getalltransactions/${token}`
//       );
...
//             trans.transaction_id.toLowerCase().includes(searchQuery) ||
//             trans.created_at.toLowerCase().includes(searchQuery) ||
//             trans.type_creditdebit.toLowerCase().includes(searchQuery)
//         );
//     }
...
//     render() {
//         const { perPage, currentPage, users } = this.state;
//         const filteredUsers = this.getFilteredUsers();
...
//                         <BsPlusLg className='text-xl mr-1' />Add Amount
//                     </button></Link>
//                 </div>
...
//                             </thead>
//                             <tbody>
//                                 {paginatedUsers.map((trans, index) => (
//                                     <tr key={index+1}>
//                                         <td className="px-2 py-5 border-b">{trans.transaction_id}</td>
//                                         <td className="px-2 py-5 border-b">Credit/Debit</td>
//                                         <td className="px-2 py-5 border-b">{trans.type_creditdebit}</td>
//                                         <td className='border-b'><button className='px-2 py-1 cursor-text rounded-md md:text-base text-sm'>{trans.amount}</button></td>
//                                         <td className='border-b'><button className={`px-2 py-1 pr-5 ${trans.status === 'Success'? 'text-green-500': 'text-red-500'}`}>{trans.status}</button></td>
//                                         <td className="px-2 py-5 border-b">{trans.remark}</td>
...
//         try {
//             const response = await axios.get(
//                 `http://localhost:8000/api/getalltransactions/${token}?page=${page}`
//             );
//             this.setState({
...
//     render() {
//         const { perPage, currentPage, transactions, totalPages, searchQuery, error } = this.state;
//         const filteredUsers = this.getFilteredUsers();
...
//                             </thead>
//                             <tbody>
//                                 {filteredUsers.map((trans, index) => (
//                                     <tr key={index + 1}>
//                                         <td className="px-2 py-5 border-b">{trans.transaction_id}</td>
//                                         <td className="px-2 py-5 border-b">Credit/Debit</td>
//                                         <td className="px-2 py-5 border-b">{trans.type_creditdebit}</td>
//                                         <td className='border-b'>
//                                             <button className='px-2 py-1 cursor-text rounded-md md:text-base text-sm'>{trans.amount}</button>
//                                         </td>
//                                         <td className='border-b'>
//                                             <button className={`px-2 py-1 pr-5 ${trans.status === 'Success' ? 'text-green-500' : 'text-red-500'}`}>{trans.status}</button>
//                                         </td>
//                                         <td className="px-2 py-5 border-b">{trans.remark}</td>
//                                         <td className="px-2 py-5 border-b">{trans.created_at}</td>
//                                     </tr>
...
//                             onChange={this.handleSearchChange}
//                         />
//                         <label htmlFor='perPage' className='ml-10 mr-1'>Show </label>
//                         <select
//                             id='perPage'
//                             className="p-2 border rounded-lg"
//                             value={perPage}
