...
//         "http://localhost:8000/api/createapimaster",
//         data
//       );
...
//   render() {
//     const { apiGroups, selectedGroup, apiName, basicPrice, starterPrice, standardPrice, advancePrice, growthPrice, unicornPrice, routeName, apiSlug } = this.state;

//     return (
//       <div className="p-8 bg-gray-100 min-h-screen">
//         <h1 className="text-4xl font-extrabold text-black mb-6">Add API</h1>
//         <div className="bg-white shadow-md rounded-lg p-6">
//           <label className="block text-sm font-semibold mb-2" htmlFor="apiGroup">
//             Api Group
//           </label>
//           <select
//             id="apiGroup"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="basicPrice">
//             Basic Price
//           </label>
//           <input
//             id="basicPrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="starterPrice">
//             Starter Price
//           </label>
//           <input
//             id="starterPrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="standardPrice">
//             Standard Price
//           </label>
//           <input
//             id="standardPrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="advancePrice">
//             Advance Price
//           </label>
//           <input
//             id="advancePrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="growthPrice">
//             Growth Price
//           </label>
//           <input
//             id="growthPrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="unicornPrice">
//             Unicorn Price
//           </label>
//           <input
//             id="unicornPrice"
...
//           <label className="block text-sm font-semibold mb-2" htmlFor="routeName">
