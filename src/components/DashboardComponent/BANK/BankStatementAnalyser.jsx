...
//       const res = await axios.post('https://regtechapi.in/api/bank_anlyser', formData, { headers });
//       console.log(res)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://regtechapi.in/api/bank_anlyser",
        formData,
        { headers }
      );
      // console.log(res);
...
// newTab.document.title = "bank_analyser.pdf";
      }
    } catch (err) {
      setError("An error occurred. Please try again later.");
    } finally {
