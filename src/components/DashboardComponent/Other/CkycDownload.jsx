  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(
        'https://regtechapi.in/api/ckycDownload',
        { pano: panNumber, dob, ckycid: ckycId },
        {
          headers: {
    ...
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-gray-50 via-gray-100 to-gray-200">
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="bg-blue-500 p-4 flex justify-between items-center">
          <h3 className="text-xl font-semibold text-white">CKYC Download</h3>
          <Link to="/dashboard/kyc/ckycdownload_api" className="text-white">
            CKYC Download APIs
          </Link>
        </div>
        <div className="p-4">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label htmlFor="ckycid" className="block text-gray-700 text-sm font-bold mb-2">CKYC ID</label>
              <input
                type="text"
                id="ckycid"
                name="ckycid"
