...
//     try {
//       const response = await axios.get('http://localhost:8000/api/getschemetypemaster');
...
//   render() {
//     const { schemeTypeMaster } = this.state;
//     return (
...
//           onClick={() => console.log('Add New Scheme')}
//         >
//           Add
//         </button></Link>
...
//                   <td className="py-3 px-4 border-b border-gray-200 text-sm text-gray-700">{scheme.hit_limit}</td>
...
class SchemeTypeMaster extends Component {
  ...
  confirmDelete = async () => {
    const { deleteId } = this.state;
      const response = await axios.post(`http://localhost:8000/api/deleteschemetypemaster/${deleteId}`);
