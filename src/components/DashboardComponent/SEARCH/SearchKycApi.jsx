...
//                     <p>
//                       <b>Hitting URL:</b> https://regtechapi.in/api/search_v2
//                     </p>
//                     <p>
//                       <b>Header:</b>
//                     </p>
...
//                   <div className="p-4 border border-black rounded">
//                     <p>
//                       <b>Hitting URL:</b> https://regtechapi.in/api/ckycSearch
//                     </p>
//                     <p>
//                       <b>Header:</b>
//                     </p>
...
class SearchV2API extends Component {
  ...
  "statusCode": null
                ...
                <div
                  className="bg-blue-300 text-black p-4 rounded cursor-pointer"
                  onClick={() => this.toggleSection("searchAPI")}
                >
                  <h4 className="font-semibold underline">Search Data (With PAN)</h4>
                </div>
                {expandedSection === "searchAPI" && (
                  <div className="p-4 border border-black rounded">
                    <p>
                      <b>Hitting URL:</b> https://regtechapi.in/api/search
                    </p>
                    <p>
                      <b>Header:</b>
                    </p>
    ...
    "kycDetails": {
      "personalIdentifiableData": {
        "personalDetails": {
          ...
          "lastName": "KUMAR",
          "dob": "09/03/1975",
          "address": "D4-101, Bramha Suncity Wadgaon Sheri Pune",
          "city": "null",
          "state": null,
          "country": "INDIA",
          "pincode": "411014",
