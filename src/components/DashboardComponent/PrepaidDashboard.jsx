          ...
          {scheme.map((schemeName) => {
                ...
                <div className="card border bg-white border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      if (schemeOption.api_slug === "aadharocrmasking") {
                        return (
                          <>
            ...
            if (
              (schemeName.api_slug === "pancard" ||
                ...
                schemeName.api_slug === "pancardocr" ||
                schemeName.api_slug === "paninfo" ||
                schemeName.api_slug === "pandetails" ||
                schemeName.api_slug === "pancardextracttext" ||
                schemeName.api_slug === "pandetails1") &&
              countpancard !== 1
            ) {
              countpancard = 1;
              return (
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      if (schemeOption.api_slug === "pandetails1") {
                        return (
                          <>
                      ...
                      if (schemeOption.api_slug === "pancardocr") {
                        return (
                          <>
                      ...
                      if (schemeOption.api_slug === "pancardextracttext") {
                        return (
                          <>
                ...
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      if (schemeOption.api_slug === "passportocr") {
                        return (
                          <>
                ...
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      // CIN Advance
                      if (schemeOption.api_slug === "cinadvance") {
                        return (
                          <>
            ...
            if (
              (schemeName.api_slug === "bank_ifsc" ||
                schemeName.api_slug === "bank" ||
                schemeName.api_slug === "bank_statement" ||
                ...
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                        ...
                        return (
                          <>
                            <Link to="/dashboard/kyc/bank_analyser">
                              <li key={schemeOption.id} className="hover:text-gray-700 mb-4 ml-6 hover:border-b-[1px] hover:border-gray-700 w-fit text-[#00acc1] text-sm border-b-[1px] border-[#00acc1] cursor-pointer">
                                Bank Analyser
                              </li>
                            </Link>
                      ...
                      if (schemeOption.api_slug === "bank") {
                        return (
                          <>
                            <Link to="/dashboard/kyc/bank_verification">
                <li key={schemeOption.id} className="hover:text-gray-700 mb-4 ml-6 hover:border-b-[1px] hover:border-gray-700 w-fit text-sm text-[#00acc1] border-b-[1px] border-[#00acc1] cursor-pointer">
                  Bank Validation
                </li>
              </Link>
                          </>
            ...
            if (
              (schemeName.api_slug === "license" ||
                schemeName.api_slug === "drivinglicenseocr" ||
                ...
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      if (schemeOption.api_slug === "drivinglicenseocr") {
                        return (
                          <>
            ...
            // **** Face Match **** //
            if ((schemeName.api_slug === "facematch" || schemeName.api_slug === "facematchone") && countvideokyc !== 1) {
              countvideokyc = 1;
              return (
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  <h2 className="text-black text-2xl font-light mb-4">
                ...
                <div className="card bg-white border border-gray-200 rounded-lg shadow-xl p-4 mx-auto md:m-2 mt-4 md:w-[30%] w-3/4 h-fit">
                  ...
                  >
                    {scheme.map((schemeOption) => {
                      ...
                      if (schemeOption.api_slug === "voteridocr") {
                        return (
                          <>
