...
class UdhyogAadharAPI extends Component {
  state = {
    ...
    showUdhyogAadharApis: true, // Initial state to show the section
  };
            ...
            {showUdhyogAadharApis && (
              <div className="space-y-4 mt-2 transition-all duration-300">
                ...
                {expandedSection === "udhyogAadhar" && (
                  <div className="p-4 border border-gray-700 rounded bg-gray-100">
                    <p>
                      <b>Hitting URL:</b>{" "}
                      https://regtechapi.in/api/udyogaadhaars
                    </p>
                    <p>
                      <b>Header:</b>
                    </p>
