...
//         try {
//             const result = await axios.post('http://regtechapi.in/api/pantogst', 
...
//                         role="button"
//                         className="btn btn-light float-right text-white underline"
//                         href="#"
//                     >
//                         PAN TO GST APIs
//                     </Link>
...
//                                 Loading... <span className="text-blue-300">please wait...</span>
//                             </div>
//                         </div>
//                     )}
//                     {error && (
