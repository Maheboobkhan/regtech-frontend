...
const PanToGST = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await axios.post(`${domain}/pantogst`, 
        ...
        <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-green-50 via-blue-50 to-purple-50">
            <div className="w-full max-w-3xl bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="bg-[#00acc1] p-4 flex justify-between">
                    ...
                    <Link to='/dashboard/kyc/pancard_api' 
                        role="button"
                ...
                <div className="p-4">
                    ...
                    {response && response.status_code === 200 && (
                        <div className="bg-green-100 text-green-800 p-3 rounded mt-4">
                            ...
                            <table className="border border-gray-700 mt-4 overflow-x-scroll">
                                <thead>
                            ...
                            <h4 className="text-center text-muted text-2xl mt-6"><strong>Address</strong></h4>
                            <hr />
                            <div className='overflow-x-auto'>
                            <table className="table-auto w-full text-center border border-gray-700 mt-4">
                                <thead>
                                    <tr className="bg-[#00acc1] text-white">
