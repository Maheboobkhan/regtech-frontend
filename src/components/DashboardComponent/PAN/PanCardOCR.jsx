...
const PanCardOCR = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const result = await axios.post(`${domain}/pancard_ocr`, formData, {
                headers: {
            ...
            <div className="w-full max-w-lg bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div className="p-4">
                    ...
                    {response && response.status_code === 200 && (
                        <div className="bg-green-100 text-green-800 p-3 rounded mt-4 flex flex-col gap-y-2">
                            <h3 className="text-2xl font-semibold">PAN CARD Details</h3>
                            <p className='text-base'><strong className='text-lg'>Pan Description: </strong>
