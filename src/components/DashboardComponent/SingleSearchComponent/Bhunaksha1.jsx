...
// const jharkhandData = [
//   // Your JSON data here (as an array of objects)
// ];
...
//   const districts = [...new Set(jharkhandData.map(item => item.District))];
  
//   // Get circles based on selected district
//   const circles = selectedDistrict 
//     ? [...new Set(jharkhandData.filter(item => item.District === selectedDistrict).map(item => item.Circle))]
//     : [];

//   // Get mauzas based on selected circle
//   const mauzas = selectedCircle 
//     ? jharkhandData.filter(item => item.Circle === selectedCircle).map(item => item.Mauza)
//     : [];
...
//       <label htmlFor="state" className="block text-2xl font-medium text-gray-700">
//         Select State
//       </label>
//       <select
//         id="state"
...
// const biharData = [
//   { District: "Patna", Circle: "Patna", Halka: "Halka-1", Mauza: "Mauza-1" },
//   { District: "hatna", Circle: "P", Halka: "Halka-2", Mauza: "Mauza-2" },
//   { District: "Gaya", Circle: "Gaya", Halka: "Halka-1", Mauza: "Mauza-3" },
...
//   const handleSubmit = (e) => {
//     e.preventDefault();
//     // Prepare the data to send to the server based on the selected state
//     let dataToSend;
...
//         State: selectedState,
//         District: selectedDistrict,
//         Taluka: circles.find(c => c === selectedCircle), // Assuming Taluka is based on Circle here
...
//           {/* {selectedCircle && selectedState === "bihar" && ( */}
//             <div className="mb-6">
...
//               </div>
//               <div className="mb-6">
//                 <label htmlFor="taluka" className="block text-lg font-medium text-gray-700">Select Taluka</label>
//                 <select
//                   id="taluka"
//                   name="taluka"
//                   className="form-select cursor-pointer mt-1 block w-full border border-[#00acc1] rounded-lg shadow-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#00acc1] focus:border-[#0097a7] transition duration-200"
...
//                   onChange={handleCircleChange}
//                 >
//                   <option value="" className="text-gray-500">--Select Taluka--</option>
//                   {circles.map(taluka => (
...
//               {selectedCircle && (
//                 <div className="mb-6">
//                   <label htmlFor="village" className="block text-lg font-medium text-gray-700">Select Village</label>
//                   <select
//                     id="village"
//                     name="village"
//                     className="form-select cursor-pointer mt-1 block w-full border border-[#00acc1] rounded-lg shadow-md py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#00acc1] focus:border-[#0097a7] transition duration-200"
...
//                     onChange={handleMauzaChange}
//                   >
//                     <option value="" className="text-gray-500">--Select Village--</option>
//                     {goaData.filter(item => item.District === selectedDistrict).map(item => (
