...
const CheckEmailVerificationStatus = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://regtechapi.in/api/seachv4', body, { headers });
      // console.log(res);
  ...
  return (
    // <div className="flex justify-center items-center min-h-screen bg-gradient-to-r from-green-50 via-blue-50 to-purple-50">
      <div className="mx-auto w-full max-w-xl bg-white shadow-lg rounded-lg overflow-hidden">
