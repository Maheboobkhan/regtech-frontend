        ...
        <div className="p-4">
          ...
          {response && response.status_code === 200 && (
            <div className="mt-6 bg-green-100 text-green-800 p-4 rounded">
              ...
              <div className="mt-4">
                <p><strong>Full Name:</strong> {response.pancard?.data?.firstName + ' ' + response.pancard?.data?.middleName + ' ' + response.pancard?.data?.lastName || 'null'}</p>
                <p><strong>PAN no:</strong> {response.pancard?.data?.panNumber || 'null'}</p>
                <p><strong>Is Valid:</strong> {response.pancard?.data?.isValid ?  '1': '0' || 'null'}</p>
                ...
                <p><strong>Aadhaar Seeding Status:</strong> {response.pancard?.data?.aadhaarSeedingStatus ? '1' : '0' || 'null'}</p>
