...
const LicenseOCR = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(`${domain}/drivingLicense_ocr`, formData, { headers });
      console.log(res);
      ...
      <div className="w-full max-w-3xl bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-4">
          ...
          {response && response.status_code === 200 && (
            <div className="mt-4 bg-green-100 text-green-800 p-3 rounded flex flex-col gap-y-2">
              <h3 className="text-2xl font-semibold">License Details</h3>
              <p><strong className='text-lg'>License Description:</strong> 
              ...
              <p><strong>Name:</strong> 
                {response.driving_license.raw_ocr_texts[21] || 'null'}
              </p>
            </div>
          )}
