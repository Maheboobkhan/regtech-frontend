...
import SearchTable from './components/DashboardComponent/SEARCH/SearchAllData';
import ResponseNew from './components/DashboardComponent/ESIGN/Response';
import GetSignDocument from './components/DashboardComponent/ESIGN/GetSing';

const App = () => {

    const location = useLocation();
    const hideFooterPaths = ['/chat','/search/data', '/dashboard', '/users', '/dem', '/failure_url', '/response_new', '/getsign'];
    ...
    return (
        <div className='overflow-x-hidden'>
            ...
            <Routes>
                ...
                <Route path="/response_new" element={<ResponseNew />} />
                {/* <Route path="/getsign/document/:id/:sign_method" element={<GetSignDocument />} /> */}
                <Route path="/getsign/document/:id/:sign_method" element={<ResponseNew />} />
            </Routes>
